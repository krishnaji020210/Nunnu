...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="‣‣I", callback_data=f"ADMIN Skip|{chat_id}"),style=ButtonStyle.DEFAULT
            InlineKeyboardButton(text="▢", callback_data=f"ADMIN Stop|{chat_id}"),style=ButtonStyle.DEFAULT
        ],
        [
            InlineKeyboardButton(text="ʀᴇᴘʟᴀʏ[↻]", callback_data=f"ADMIN Replay|{chat_id}"),style=ButtonStyle.DANGER
            InlineKeyboardButton(text="ᴄʟᴏsᴇ[✗]", callback_data="close",style=ButtonStyle.SUCCESS
            )
        ],
    ]
    return buttons
